  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        companyName: formData.companyName !== '' ? formData.companyName.trim() : (savedSettings?.companyName || 'Clarity InfoTech'),
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-muted/50 border border-border rounded-xl p-2.5 text-foreground placeholder:text-muted-foreground/60"
                placeholder={savedSettings?.companyName ? `Eg. ${savedSettings.companyName}` : "Eg. Clarity InfoTech"}
              />
            </div>
            <div>
