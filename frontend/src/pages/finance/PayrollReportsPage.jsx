        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-card border border-border p-6 rounded-2xl shadow-sm">
          <div>
            <h1 className="text-2xl font-black text-foreground flex items-center gap-2">
              <BarChart3 className="w-6 h-6 text-emerald-600" /> Payroll Financial Reports & Analytics
            </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-card border border-border p-5 rounded-2xl shadow-sm space-y-2">
                ...
                <p className="text-2xl font-black text-emerald-600 dark:text-emerald-400">{formatINR(reports?.totalNetExpense)}</p>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-4">
              <h3 className="text-lg font-bold text-foreground flex items-center gap-2">
                <Users className="w-5 h-5 text-emerald-600" /> Department-Wise Payroll Analysis
              </h3>
