    ...
    <div className="space-y-6 text-left font-sans w-full max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-card border border-border p-6 rounded-2xl shadow-sm">
          <div>
            <h1 className="text-2xl font-black text-foreground flex items-center gap-2">
              <Layers className="w-6 h-6 text-emerald-600" /> Salary Structure Templates
            </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold text-sm transition-all shadow-md"
          >
        ...
        {loading ? (
          ...
          <div className="bg-card border border-border rounded-2xl p-12 text-center text-muted-foreground space-y-2">
            <Layers className="w-8 h-8 mx-auto opacity-50 text-emerald-600" />
                ...
                <div key={t.id} className="bg-card border border-border rounded-2xl p-5 shadow-sm space-y-4 relative flex flex-col justify-between">
                  <div>
                    <div className="flex items-start justify-between">
                      <div>
                        <span className="px-2.5 py-0.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-full text-[10px] font-black uppercase">
                          {t.targetRole}
                        </span>
                  ...
                  <div className="pt-3 border-t border-border/60 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-black text-emerald-600 dark:text-emerald-400">{formatINR(net)}</p>
                    </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto space-y-4 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <div className="pt-4 flex justify-end gap-2 border-t border-border">
                  ...
                  <button type="submit" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold">Save Template</button>
                </div>
              </form>
            </div>
          </div>
